...
cube2 = iris.load('japp_lehtinen_new.nc')[0]
...
cube4 = iris.load('jveh_lehtinen_new.nc')[0]
plt.figure()
plt.xlabel('Jveh')
plt.ylabel('Model_level_number')
...
cube6 = iris.load('coag3nm_lehtinen_new.nc')[0]
cube7 = iris.load('coag1nm_lehtinen_new.nc')[0]
plt.figure()
