...
cube2 = iris.load('japp_lehtinen_rc_v2.nc')[0]
...
cube4 = iris.load('jveh_lehtinen_rc_v2.nc')[0]
plt.figure()
plt.xlabel('Jveh')
plt.ylabel('Model_level_number')
...
cube6 = iris.load('coag3nm_lehtinen_rc_v2.nc')[0]
cube7 = iris.load('coag1nm_lehtinen_rc_v2.nc')[0]
plt.figure()
...
cube8 = iris.load('m_leh_lehtinen_rc_v2.nc')[0]
#print cube8.data
