...
cube2 = iris.load('japp_lehtinen_2017.nc')[0]

l_indx = 85

level_num = cube1.coord('model_level_number').points[0:l_indx]
plt.figure()
plt.xlabel('Japp')
plt.ylabel('Model_level_number')
plt.plot((cube1[0:l_indx,72,96].data),level_num,'b*-',(cube2[0:l_indx,72,96].data),level_num,'r*-')
...
plt.ylabel('Model_level_number')
plt.plot((cube1[0:l_indx,72,96].data),level_num,'b*-')
...
plt.ylabel('Model_level_number')
plt.plot((cube2[0:l_indx,72,96].data),level_num,'b*-')
...
cube4 = iris.load('jveh_lehtinen_2017.nc')[0]
plt.figure()
plt.xlabel('Jveh')
plt.ylabel('Model_level_number')
#level_num_all = np.arange(1,86,1)
plt.plot((cube3[0:l_indx,72,96].data),level_num,'b*-',(cube4[0:l_indx,72,96].data),level_num,'r*-')
...
plt.ylabel('Model_level_number')
#level_num_all = np.arange(1,86,1)
plt.plot((cube5[0:l_indx:,72,96].data),level_num,'b*-')
plt.title('Condensation sink at (0,0)')
plt.grid(True)

# plot of coagulation sink

cube6 = iris.load('coag3nm_lehtinen_2017.nc')[0]
cube7 = iris.load('coag1nm_lehtinen_2017.nc')[0]
plt.figure()
plt.xlabel('coagulation sink (s-1)')
plt.ylabel('Model_level_number')
#level_num_all = np.arange(1,86,1)
plt.plot((cube6[0:l_indx,72,96].data),level_num,'b*-',(cube7[0:l_indx,72,96].data),level_num,'r*-')
...
cube8 = iris.load('m_leh_lehtinen_2017.nc')[0]
...
plt.ylabel('Model_level_number')
#level_num_all = np.arange(1,86,1)
plt.plot((cube8.data[0:l_indx,72,96]),level_num,'b*-')
#plt.plot((cube8[:,72,96]),level_num_all,'b*-')
plt.title('Factor m  at (0,0)')
plt.grid(True)

cube9 = iris.load('rc_2017.nc')[0]
plt.figure()
plt.xlabel('rc (critical radius)')
plt.ylabel('Model_level_number')
#level_num_all = np.arange(1,86,1)
plt.plot((cube9.data[0:l_indx,72,96]),level_num,'b*-')
#plt.plot((cube8[:,72,96]),level_num_all,'b*-')
plt.title('critical radius  at (0,0)')
plt.grid(True)
