...
#ANANTH CHANGE MADE TO DIR_SCRIPTS
...
LOGFILES_Directory_Path = dir_scripts
...
#or just as:
print sys.argv #ANANTH DEBUGGING
if len(sys.argv)>1:
    ...
    input_files_directory='/group_workspaces/jasmin2/gassp/eeara/' #ANANTH CHANGE MADE
    input_files_directory='/group_workspaces/jasmin2/gassp/eeara/'    #ANANTH
...
#ANANTH orog_file path and file attached
"""

if model_name is "UKCA":
    orog_file='/group_workspaces/jasmin2/gassp/eeara/ax337a.pm2014apr.pp'
...
if run_L0:
    if model_name == "TOMCAT_GLOMAP":
        ...
        execfile("L0_processing_ananth.py")
