...
cube2 = iris.load('japp_lehtinen_rc_units_3600.nc')[0]
...
cube4 = iris.load('jveh_lehtinen_rc_units_3600.nc')[0]
plt.figure()
plt.xlabel('Jveh')
plt.ylabel('Model_level_number')
...
cube6 = iris.load('coag3nm_lehtinen_rc_units_3600.nc')[0]
cube7 = iris.load('coag1nm_lehtinen_rc_units_3600.nc')[0]
plt.figure()
...
#cube8 = iris.load('m_leh_lehtinen_rc_units_3600.nc')[0]
#print cube8.data
...
"""
cube9 = iris.load('rc_units_3600.nc')[0]
plt.figure()
plt.xlabel('rc (critical radius)')
plt.ylabel('Model_level_number')
level_num_all = np.arange(1,86,1)
plt.plot((cube9.data[:,72,96]),level_num_all,'b*-')
#plt.plot((cube8[:,72,96]),level_num_all,'b*-')
